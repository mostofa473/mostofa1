...
\033[1;93m __  __  ____   _____ _______ ____  ______ 

\033[1;93m |  \/  |/ __ \ / ____|__   __/ __ \|  ____/\

\033[1;93m | \  / | |  | | (___    | | | |  | | |__ /  \

\033[1;93m | |\/| | |  | |\___ \   | | | |  | |  __/ /\ \

\033[1;93m | |  | | |__| |____) |  | | | |__| | | / ____ \ 

\033[1;93m | |  | | |__| |____) |  | | | |__| | | / ____ \ 

\033[1;93m |_|  |_|\____/|_____/   |_|  \____/|_|/_/    \_\
...
\033[1;92m Hi I’m Md Mostafa Kamal 

\033[1;94mI’m living in BANGLADESH 
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW THE MOSTAFA ")
    ...
    print("\033[1;91m[0]\033[1;97mEXIT THE MOSTAFA")
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100000163291992")
...
def menu_select():
	...
	print ("[!] ALLAH  HAFIZ M4S94T Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
